...
ALTER TABLE public.submissions
    ...
    ADD COLUMN IF NOT EXISTS typing_burst_coverage DOUBLE PRECISION NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS system_check_count   INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS self_correction_count INTEGER NOT NULL DEFAULT 0;
